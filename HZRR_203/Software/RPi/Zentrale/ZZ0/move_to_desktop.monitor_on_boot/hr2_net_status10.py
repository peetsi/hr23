...
def perform(a,fo,modules,regs,tests):
    ''' perform commands from menu
        a        selection from menu, e.g. "1" or "t2"
        fo       file handle for statistics output file 
        modules  list of modules to be used
        regs     list of regulators 0,1,2,3 to be used
        tests    number of tests to be performed
    '''
