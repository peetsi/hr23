...
def parse_answer():
    ...
    print("parse_answer: st.rxCmd=",using_rxCmd)
    if ((using_rxCmd=="") or (len(using_rxCmd) < 9)):
        print("received data trash. won't proceed with that, wait for next cycle.")
        return
    try:
        ...
        print("parse_answer() value_error:", e)
        return 2
    except Exception as e:
        print("parse_answer() error:", e)
        return 1
            ...
            for v in l:
                ...
                if v == "S" or v == "W" :
                    ...
                    try:
                        ...
                        print("parser_answer() value_error:", e)
                    except Exception as e:
                        print("parse_answer() error:", e)
            #print(cn2)
            return True
