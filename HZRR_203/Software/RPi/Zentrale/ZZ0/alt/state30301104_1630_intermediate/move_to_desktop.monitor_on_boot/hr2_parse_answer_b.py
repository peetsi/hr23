...
def parse_answer():
    ...
    # csum="0A00"; lrc="3F"
    vor.vorlaut(5,"parse_answer: st.rxCmd=%s"%(st.rxCmd))
    if st.rxCmd=="":
        return
    ...
    #vor.vorlaut(5,"parse_answer: truncated st.rxCmd=",st.rxCmd)
    ...
    # sends regulator parameter -> new command
        ...
        vor.vorlaut(5,"parse_answer %02x: st.rxCmd = %s"%(st.rxCmdNr,st.rxCmd))
        if st.rxSubAdr == 0:
